...
// CRUD: Danh sách, thêm , sửa, xem, xóa
// User: 
...
use Hoang9104\Setup\Controllers\Admin\UserController;

$router->mount('/admin', function () use ($router) {
   //  CRUD USER
   $router->mount('/users', function () use ($router) {
      //  CRUD USER
      $router->get('/',             UserController::class . '@index');  // /admin/users/
      $router->get('/create',       UserController::class . '@create'); // /admin/users/create
